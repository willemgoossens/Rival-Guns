    ...
    <ul class="nav nav-fill nav-tabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link <?php if(!isset($_SESSION['tab2_error']) && !isset($_SESSION['tab2_success'])) echo "active"; ?>" aria-controls="editAdmins"
                <?php 
                  if( ! isset($_SESSION['tab2_error']) && ! isset($_SESSION['tab2_success'])) echo "aria-selected=\"true\""; else echo "aria-selected=\"false\"";?> data-toggle="tab" role="tab" href="#editAdmins">Add & Edit Admins</a>
        </li>
        <li class="nav-item">
